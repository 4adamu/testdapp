  ...
  return (
    <div className="wrap page-section grid-bg">
      ...
      <div className="strip mt-16">
        ...
        <div><div className="tag">Distribution</div><div className="strip-v">Airdrop</div><div className="strip-s">no sale · community first</div></div>
        <div><div className="tag">Airdrop</div><div className="strip-v">10 <span style={{fontSize:20,opacity:.6}}>each</span></div><div className="strip-s">FCFS · eligible wallets only</div></div>
        <div><div className="tag">LP lock until</div><div className="strip-v">2030</div><div className="strip-s">on UniCrypt · paired with ETH</div></div>
      </div>
...
function LiquidityPage() {
  ...
  const steps = [
    ['Seed initial liquidity', 'Team seeds the ELING/ETH pool with the liquidity allocation paired with ETH. No public sale — tokens go directly to LP.'],
    ['Mint full-range v4 LP', 'Liquidity allocation + ETH deposited into the ELING/ETH pool. Full-range so the hook fires for any swap.'],
      ...
      <div className="cols-12 mt-8">
        ...
        <div className="col-5 card card-lg">
          ...
          <div style={{ display:'flex', flexDirection:'column', gap:10, marginTop:16 }}>
            {[['Pair','$ELING / ETH'],['Pool fee','0.30%'],['Range','Full range'],['Source','Liquidity allocation (no sale)'],['Lock venue','UniCrypt'],['Unlock','Jan 1, 2030 UTC']].map(([k,v]) => (
    ...
    <>
      ...
      <div className="marquee-wrap">
        <div className="marquee">
          <span>★ We Inspired By UniPeg ★ It's an Experiment Project ★ Liquidity Locked on UniCrypt until 2030 ★ 10,000 $ELING supply ★ Airdrop only · no sale ★ 32×32 on-chain SVG ★ Uniswap v4 hook ★</span>
          <span>★ We Inspired By UniPeg ★ It's an Experiment Project ★ Liquidity Locked on UniCrypt until 2030 ★ 10,000 $ELING supply ★ Airdrop only · no sale ★ 32×32 on-chain SVG ★ Uniswap v4 hook ★</span>
        </div>
      </div>
